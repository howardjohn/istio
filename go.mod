...
require (
	...
	github.com/envoyproxy/go-control-plane v0.11.2-0.20230824015157-655f4c96d8fb
	...
	istio.io/api v1.19.0-alpha.1.0.20230829094834-68bd84f7b0c2
	istio.io/client-go v1.19.0-alpha.1.0.20230829095435-98ad1e819fb3
	k8s.io/api v0.28.1
