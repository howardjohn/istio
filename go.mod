...
require (
	...
	github.com/envoyproxy/go-control-plane v0.11.2-0.20231123142102-d5005abcab66
	...
	istio.io/api v1.19.0-alpha.1.0.20231129233224-7aeccb2eeeae
	istio.io/client-go v1.19.0-alpha.1.0.20231129233624-bee27473ec17
	k8s.io/api v0.28.4
