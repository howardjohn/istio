...
replace sigs.k8s.io/gateway-api => github.com/howardjohn/gateway-api v0.0.0-20240213173405-39512788da35
...
require (
	...
	github.com/envoyproxy/go-control-plane v0.12.1-0.20240210150233-c5bcd7ef7dfc
	...
	istio.io/api v1.19.0-alpha.1.0.20240213000336-1e8985d0cbca
	istio.io/client-go v1.19.0-alpha.1.0.20240213000935-6b28f0d2d440
	k8s.io/api v0.29.1
