...
func TestInjection(t *testing.T) {
	...
	cases := []testCase{
		...
		},
		{
			...
			mesh: func(m *meshapi.MeshConfig) {
				m.DefaultConfig.DrainDuration = duration.New(time.Second * 23)
				m.DefaultConfig.ParentShutdownDuration = duration.New(time.Second * 42)
			},
		},
		{
