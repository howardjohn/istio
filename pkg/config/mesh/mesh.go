...
func applyMeshConfigInternal(config string, defaultConfig meshconfig.MeshConfig, unmarshal func(yml string, pb proto.Message) error, marshal func(msg proto.Message) (string, error)) (*meshconfig.MeshConfig, error) {
