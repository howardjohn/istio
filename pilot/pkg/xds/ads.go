...
// To satisify methods that need DiscoveryRequest. Not suitable for real usage
func tempToSotw(request *discovery.DeltaDiscoveryRequest) *discovery.DiscoveryRequest {
