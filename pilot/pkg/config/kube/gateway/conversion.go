...
func namespacesFromSelector(ctx krt.HandlerContext, localNamespace string, Namespaces krt.Collection[*corev1.Namespace], lr *k8s.AllowedRoutes) []string {
	...
	namespaces := []string{}
	namespaceObjects := krt.Fetch(ctx, Namespaces)
